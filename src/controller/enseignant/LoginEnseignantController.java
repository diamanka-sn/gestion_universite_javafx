...
public class LoginEnseignantController {
    ...
    void Connexion(ActionEvent event) {
        ...
        String sql = "SELECT matricule,passe FROM compteenseignant Where matricule = ? and passe = ?";
        ...
        try {
            ...
            if (!rs.next()) {
                ...
                Scene scene = null;
                try {
                    scene = new Scene(FXMLLoader.load((getClass().getResource("/vue/enseignant/PageEnseignant.fxml"))));
