...
public class formationController {
    ...
    void Ajouter() {
        ...
        if (matricule1.equals("") || nom.equals("") || prenom.equals("") || email.equals("")) {
            ...
            String sql = "INSERT INTO responsableFormation(matricule,nomResponsable,prenomResponsable,email) values(?,?,?,?)";
            try {
    ...
    void Autorisation() {
        ...
        if (passe.equals("")) {
            ...
            String Sql = "INSERT INTO compteResponsableFormation(idCompteResponsable,matricule,passe) values(?,?,?)";
